...
const annotations = [
  ...
  },
  {
    ...
    variant_request: { status: 'unresolved' },
  },
  {
...
test('background bulk deletion removes local records and leaves tombstones for server synchronization', async () => {
  ...
  const context = vm.createContext({
    ...
    WaypointVariantPolicy: { assertDeleteAllowed: () => { throw new Error('maintenance deletion must not use the ordinary deletion guard'); } },
