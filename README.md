...
Waypoint owns the Design Actions workflow and Annotation lifecycle; Impeccable supplies the external design discipline, not a second work-state system. An authored Design Intent may include separate Variant Intent. After an agent generates candidates, Waypoint creates and governs the Variant Set, its Active Variant, and Finalization cleanup.
